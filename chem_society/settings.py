"""
Django settings for chem_society project.
...
SECRET_KEY = 'django-insecure-63yi^u=9kxvc&r)cu&(as3woz7w%r!ljn$677rideo#zi3cq1r'
...
WSGI_APPLICATION = 'chem_society.wsgi.application'
